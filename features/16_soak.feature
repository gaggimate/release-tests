Feature: Long-running stability
  ...
  Scenario: 24-hour idle soak
    ...
    Then neither device reboots (check uptime on the System tab)
  ...
  Scenario: Scale connect/disconnect cycling
    When I switch the scale off and on 30 times during Brew mode
